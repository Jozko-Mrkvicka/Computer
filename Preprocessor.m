...
% and converts it into machine (raw) code. Function 
% replaces common instruction name (like MOV) by specific 
% instrucion name (like MOVcr) according to its operands.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                 end
        ...
        case TPR
            if (0 ~= inst_suffix) && ...
               ...
               (6 ~= inst_suffix) && ...
               (7 ~= inst_suffix) && ...
                fprintf('ERROR#11 (line %d): Instruction TPR: Wrong combination of operands!!!\n', i);
                error_code = 1;
            end
        ...
        case LOAD
            if (0 ~= inst_suffix) && ...
               ...
               (3 ~= inst_suffix) && ...
               (4 ~= inst_suffix) && ...
                fprintf('ERROR#11 (line %d): Instruction LOAD: Wrong combination of operands!!!\n', i);
                error_code = 1;
            end
