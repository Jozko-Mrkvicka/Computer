...
SourceCode = ...
[
                    MOVL            col                 7                           ... % Initial position of point/pixel to take.
                    STOREI          lsb(ADDR_POINT_X)   col                         ...
                    MOVL            row                 8                           ...
                    STOREI          lsb(ADDR_POINT_Y)   row                         ...
                    MOVL            r12                 PIX_ON                      ... % Video Controller command (SetPixel1).
                    MOVL            r11                 PIX_OFF                     ... % Video Controller command (SetPixel0).
                    STOREI          lsb(c.VIDEO_CTRL)   r12                         ...
                                                                                    ...
                    MOVL            r0                  -1                          ... % Init value of X-increment.
                    STOREI          lsb(ADDR_INCR_X)    r0                          ...
                    MOVL            r0                  lsb(ADDR_INIT_TAIL + 1)     ... % r0 points to one address behind the tail.
                    MOVU            r0                  msb(ADDR_INIT_TAIL + 1)     ... % r0 points to one address behind the tail.
                    STOREI          lsb(P_TAIL_ADDR)    r0                          ... % Pointer to the snake`s tail (an address where the address of snake`s tail is stored).
                    CALL            FNC_INIT_SNAKE                                  ...
...
FNC_DRAW_SNAKE_     PUSH            r0                                              ...
                    ...
                    PUSH            row                                             ...
                    PUSH            r3                                              ...
                    LOADI           r3                  lsb(P_TAIL_ADDR)            ... % r3 points to one address behind the tail.
                    MOVL            r0                  lsb(ADDR_HEAD)              ... % r0 points to head address.
                    MOVU            r0                  msb(ADDR_HEAD)              ... % r0 points to head address.
DRAW_LOOP_          LOAD            col                 m(r0)                       ... % col contains snake.x.
                    ADDI            r0                  1                           ...
                    LOAD            row                 m(r0)                       ... % row contains snake.y.
                    ADDI            r0                  1                           ...
                    STOREI          lsb(c.VIDEO_CTRL)   r12                         ... % Video Controller command (SetPixel1).
                    CMP             r0                  r3                          ...
                    JLT             DRAW_LOOP                                       ... % Loop until whole snake is drawn.
                    POP             r3                                              ...
                    POP             row                                             ...
                    POP             col                                             ... 
                    POP             r0                                              ...
...
FNC_CHECK_          PUSH            r0                                              ...
                    ...
                    PUSH            r2                                              ...
                    PUSH            r3                                              ...
                    LOADI           r0                  lsb(ADDR_POINT_X)           ...
                    LOADI           r1                  lsb(ADDR_POINT_Y)           ...
                    LOADI           r2                  lsb(ADDR_HEAD)              ...
                    LOADI           r3                  lsb(ADDR_HEAD + 1)          ...
                                                                                    ...
                    CMP             r0                  r2                          ... % Check that snake reached next point.
                    JPE             CHECK_CONTINUE1                                 ...
                    JMP             CHECK_EXIT                                      ...
CHECK_CONTINUE1_    CMP             r1                  r3                          ...
                    JPE             CHECK_CONTINUE2                                 ...
                    JMP             CHECK_EXIT                                      ...
                                                                                    ...
CHECK_CONTINUE2_    LOADI           r0                  lsb(P_TAIL_ADDR)            ... % Increase snake`s length by 2.
                    ADDI            r0                  2                           ...
                    STOREI          lsb(P_TAIL_ADDR)    r0                          ...
                                                                                    ...
                    LOADI           r1                  lsb(P_TAIL_ADDR)            ...
...
FNC_INIT_SNAKE_     PUSH            r0                                              ... % Init snake to: [5,5], [5,6], [5,7].
                    ...
                    STOREI          lsb(ADDR_HEAD + 0)  r0                          ... % Save snake.x to RAM.
                    STOREI          lsb(ADDR_HEAD + 1)  r0                          ... % Save snake.y to RAM.
                    STOREI          lsb(ADDR_HEAD + 3)  r0                          ...
                    STOREI          lsb(ADDR_HEAD + 5)  r0                          ...
                    MOVL            r0                  6                           ...
                    STOREI          lsb(ADDR_HEAD + 2)  r0                          ...
                    MOVL            r0                  7                           ...
                    STOREI          lsb(ADDR_HEAD + 4)  r0                          ...
                    POP             r0                                              ...
                    RET                                                             ...
                                                                                    ...
                                                                                    ...
...
FNC_READ_DIR_       PUSH            r0                                              ... % New direction (read from keyboard);
                    ...
                    LOADI           r2                  lsb(ADDR_DIRECTION)         ... % Read old direction from memory.
                                                                                    ...
                    MOVL            r1                  lsb(c.KEYBOARD)             ...
                    MOVU            r1                  msb(c.KEYBOARD)             ...
                    LOAD            r0                  m(r1)                       ... % Read new direction from keyboard.
                                                                                    ...
                    CMPI            r0                  BTN_2                       ...
...
DIR_DOWN_           CMPI            r2                  BTN_8                       ... % Check that direction was not reverted.
                    ...
                    MOVL            r2                  1                           ... % Y = +1
                                                                                    ...
DIR_SAVE_           STOREI          lsb(ADDR_INCR_X)    r1                          ... % Save new (current) X-increment to memory.
                    STOREI          lsb(ADDR_INCR_Y)    r2                          ... % Save new (current) Y-increment to memory.
                    STOREI          lsb(ADDR_DIRECTION) r0                          ...
                                                                                    ...
DIR_EXIT_           POP             r2                                              ...
                    POP             r1                                              ...
                    POP             r0                                              ...
...
MOVE_LOOP_          LOAD            r0                  m(r2)                       ... % Copy snake`s Y-position to r0.
                    ...
                    MOVL            r0                  lsb(ADDR_HEAD + 1)          ...
                    MOVU            r0                  msb(ADDR_HEAD + 1)          ...
                    CMP             r0                  r1                          ...
                    JLT             MOVE_LOOP                                       ... % Loop until all snake (but head) is shifted.
                                                                                    ...
                    LOADI           r0                  lsb(ADDR_INCR_X)            ... % Update snake`s head X-positon based on new direction (X-increase).
                    LOADI           r1                  lsb(ADDR_HEAD)              ...
                    ADD             r1                  r0                          ...
                    STOREI          lsb(ADDR_HEAD)      r1                          ...
                                                                                    ...
                    LOADI           r0                  lsb(ADDR_INCR_Y)            ... % Update snake`s head Y-positon based on new direction (Y-increase).
                    LOADI           r1                  lsb(ADDR_HEAD + 1)          ...
                    ADD             r1                  r0                          ... % ADD           r1          r0 -> este nemam implementovanu instrukciu load upper byte
                    STOREI          lsb(ADDR_HEAD + 1)  r1                          ...
                                                                                    ...
                    POP             r2                                              ...
                    POP             r1                                              ...
                    POP             r0                                              ...
...
%                   MOVL            r0                  lsb(ADDR_HEAD)              ... % r0 points to head address.
%                   MOVU            r0                  msb(ADDR_HEAD)              ... % r0 points to head address.
% ERASE_LOOP_           LOAD            col                 m(r0)                       ... % col contains snake.x.
%                   ADDI            r0                  1                           ...
%                   LOAD            row                 m(r0)                       ... % row contains snake.y.
%                   ADDI            r0                  1                           ...
%                   STOREI          lsb(c.VIDEO_CTRL)   r11                         ...
%                   CMP             r0                  r3                          ...
