...
SourceCode = ...
[
					MOVU			base 				msb(c.RAM_START)			... % Init upper byte of the base register with upper byte of start RAM address.
																					...
					MOVL			col					7							... % Initial position of point/pixel to take.
					STOREI			lsb(ADDR_POINT_X)	col							...
					MOVL			row					8							...
					STOREI			lsb(ADDR_POINT_Y)	row							...
					MOVL			r12					3							... % Video Controller command (SetPixel1).
					MOVL			r11					2							... % Video Controller command (SetPixel0).
...
FNC_CHECK_			PUSH			r0												...
					...
					JNE				CHECK_EXIT										...
																					...
					LOADI			r0					lsb(P_TAIL_ADDR)			... % Increase snake`s length by 2.
					ADDI			r0					2							...
