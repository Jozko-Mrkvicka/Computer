...
MODEL              = Pokus09_Display_4x4
MODULES            = Pokus09_Display_4x4_acc_data.c rt_zcfcn.c 
MAKEFILE           = Pokus09_Display_4x4.mk
MATLAB_ROOT        = D:/Programy/MATLAB_R2013a
ALT_MATLAB_ROOT    = D:/Programy/MATLAB~2
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/06_Projekty/Computer
MATLAB_BIN         = D:/Programy/MATLAB_R2013a/bin
ALT_MATLAB_BIN     = D:/Programy/MATLAB~2/bin
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
MODELLIB                  = Pokus09_Display_4x4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/Pokus09_Display_4x4 \
	-I$(START_DIR) \
	-I$(START_DIR)/Pokus \
	-I$(MATLAB_ROOT)/toolbox/dsp/include \
	-I$(MATLAB_ROOT)/toolbox/comm/extern/include \
...
%.obj : $(MATLAB_ROOT)/toolbox/comm/extern/src/%.c
	$(CC) $(MEX_FLAGS) $(INCLUDES) $<

%.obj : $(MATLAB_ROOT)/toolbox/comm/extern/include/%.c
	$(CC) $(MEX_FLAGS) $(INCLUDES) $<
