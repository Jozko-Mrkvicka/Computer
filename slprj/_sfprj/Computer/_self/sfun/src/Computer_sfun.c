...
uint32_T _ComputerMachineNumber_;
real_T _sfTime_;

/* Function Declarations */

/* Function Definitions */
void Computer_initializer(void)
{
}

void Computer_terminator(void)
{
}
...
unsigned int sf_Computer_process_check_sum_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3671420366U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1466611049U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1963099736U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(485396889U);
...
unsigned int sf_Computer_autoinheritance_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
...
unsigned int sf_Computer_get_eml_resolved_functions_info( int nlhs, mxArray *
...
unsigned int sf_Computer_third_party_uses_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void Computer_register_exported_symbols(SimStruct* S)
{
}

static mxArray* sRtwOptimizationInfoStruct= NULL;
mxArray* load_Computer_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info("Computer",
      "Computer");
...
void unload_Computer_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct!=NULL) {
