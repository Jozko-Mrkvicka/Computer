function Test_Byte_Multiplexers()
	...
	% Expected = [206  57];
	% test('Test_Byte_Multiplexer_2_to_1_DirSel', Input, Expected);
	...
	% Expected = [ 10 128 206  57];
	% test('Test_Byte_Multiplexer_4_to_1_DirSel', Input, Expected);
	...
	% Expected = [ 10 128 206  57 105  44 232 153];
	% test('Test_Byte_Multiplexer_8_to_1_DirSel', Input, Expected);
	...
	Data12 =   [144 144 144 144 144 144 144 144 144 144 144 144 144 144 144 144];
	Data11 =   [ 68  68  68  68  68  68  68  68  68  68  68  68  68  68  68  68];
	Data10 =   [214 214 214 214 214 214 214 214 214 214 214 214 214 214 214 214];
	...
	Data07 =   [153 153 153 153 153 153 153 153 153 153 153 153 153 153 153 153];
	...
	Data03 =   [ 57  57  57  57  57  57  57  57  57  57  57  57  57  57  57  57];
	...
	Data00 =   [ 10  10  10  10  10  10  10  10  10  10  10  10  10  10  10  10];
	...
	Expected = [ 10 128 206  57 105  44 232 153 110 111 214  68 144  44 201 255];
	test('Test_Byte_Multiplexer_16_to_1', Input, Expected);
	...
	Expected = [   10   128   206    57   105    44   232   153   110   111   214    68   144    44   201   255];
	test('Test_Byte_Multiplexer_16_to_1_DirSel', Input, Expected);
end
